...
class location_obfuscation:
    ...
    def get_location(self):
        ...
        request_string = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" \
                         + str(self.lat) + "," + str(self.long) + "&sensor=true" + "&key=AIzaSyDou720GbkIU_-G4d7ilis6eAzVvltsJJg"
    ...
    def find_coord(self, subloc, loc):
        request_string = "https://maps.googleapis.com/maps/api/geocode/json?address=" + subloc + ",+" + loc + "&key=AIzaSyDou720GbkIU_-G4d7ilis6eAzVvltsJJg"
        response = requests.get(request_string)
